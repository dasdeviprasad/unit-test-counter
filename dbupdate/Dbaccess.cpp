...
HISTORY:
28-FEB-05  RET  New.
09-JUL-07  RET  Update to version 2.0 of the database for the
                  Research Version of EGGSAS.
                    Add iUpdate_study_101_200().
06-AUG-07  RET  Program version 1.2, Database version 2.01
                  Research Version of EGGSAS.
                    Add iAdd_event_table_201().
07-FEB-08  RET  Version 2.02 of the database.
                  Add methods:
                    iAdd_whatif_table_202(), iUpdate_study_201_202
29-AUG-08  RET  Version 2.03 of the database.
                  Add methods:
                    iGet_bool(), iUpdate_patient_202_203().
                  Add SQL defines:
                    SQL_GET_PATIENT_ORDER, SQL_UPDATE_PATIENT
02-SEP-12  RET  Version 2.04 of the database.
                  Add methods: iUpdate_patient_203_204()
13-SEP-12  RET  Version 2.04 of the database.
                  ...
                  Add columns to the StudyData table for new indications.
                    Change methods: iUpdate_patient_203_204()
                    Add methods: iAdd_diag_key_phrase_desc(), iAdd_ICD_code()
27-FEB-13  RET  Version 2.05 of the database.
                  Add methods: iUpdate_patient_204_205()
16-MAR-13  RET  Version 2.06 of the database.
                  Add methods: iUpdate_patient_205_206()
22-JAN-19  RET  DB Ver 2.06, product ver 1.6
                  Add ability to specify a different database on the  command line.
                    ...
                    Change methods: Constructor, sqlrDB_connect()
********************************************************************/
...
CDbaccess::CDbaccess()
  ...
  if(g_cstrDBFile.IsEmpty() == false)
    { // Database specified on the command line.
    m_bStdDB = false;
    m_cstrDSN = g_cstrDBFile;
    }
  else
    { // Use standard database.
    m_bStdDB = true;
    m_cstrDSN = DSN_DEFAULT;
    }
      ...
      if(SQL_SUCCEEDED(s_sqlrSts))
        ...
        if(SQL_SUCCEEDED(s_sqlrSts))
          ...
          if(m_cstrDSN == DSN_DEFAULT)
            cstrConnStr.Format("DSN=%s", m_cstrDSN); // Standard database.
          else
            cstrConnStr.Format(
              "Driver={Microsoft Access Driver (*.mdb)};DBQ=%s", m_cstrDSN); // database from command line.
...
********************************************************************/
short int CDbaccess::iReport_err(SQLHANDLE sqlhHandle, bool bDisplayMsgBox)
  {
  SQLRETURN sqlrRet;
  ...
  if(iDBConnect() == SUCCESS)
    ...
    if(sqlhHandle != NULL)
      ...
      if(sqlrRet == SQL_NO_DATA)
        ...
        ((CdbupdateApp *)AfxGetApp())->vLog(m_cstrErr);
...
iUpdate_patient_202_203 - Update from version 2.02 to version 2.03:
 ...
 Process:
  ...
  return: SUCCESS if the operation was successful.
          FAIL if there was an error.
********************************************************************/
short int CDbaccess::iUpdate_patient_202_203()
  {
  short int iRet = FAIL;
  CString cstrSQL;
  long lPatientID;
...
iUpdate_patient_203_204 - Update from version 2.03 to version 2.04:
  ...
  return: SUCCESS if the operation was successful.
          FAIL if there was an error.
********************************************************************/
short int CDbaccess::iUpdate_patient_203_204()
  {
  short int iRet = FAIL;
  CString cstrSQL;
...
iAdd_diag_key_phrase_desc - Add a diagnosis key phrase and a description
  ...
  return: SUCCESS if the operation was successful.
          FAIL if there was an error.
********************************************************************/
short int CDbaccess::iAdd_diag_key_phrase_desc(char *pszKeyPhrase, char *pszDesc)
  {
  short int iRet = FAIL;
  CString cstrSQL;
...
iAdd_ICD_code - Add an ICD code to the ICDCode table.
  ...
  return: SUCCESS if the operation was successful.
          FAIL if there was an error.
********************************************************************/
short int CDbaccess::iAdd_ICD_code(char *pszCode)
  {
  short int iRet = FAIL;
  CString cstrSQL;
...
iUpdate_patient_204_205 - Update from version 2.04 to version 2.05:
  ...
  return: SUCCESS if the operation was successful.
          FAIL if there was an error.
********************************************************************/
short int CDbaccess::iUpdate_patient_204_205()
  {
  short int iRet = FAIL;
  CString cstrSQL;
...
iUpdate_patient_205_206 - Update from version 2.05 to version 2.06:
  ...
  return: SUCCESS if the operation was successful.
          FAIL if there was an error.
********************************************************************/
short int CDbaccess::iUpdate_patient_205_206()
  {
  short int iRet = FAIL;
  CString cstrSQL;
...
********************************************************************/
int CDbaccess::iUpdate_study_100_101(void)
  {
  CString cstrSQL;
  short int iRet = FAIL;
...
iUpdate_study_101_200 - Update the StudyData database table from
  ...
  return: SUCCESS if the table was updated.
          FAIL if there was an errorl
********************************************************************/
int CDbaccess::iUpdate_study_101_200(void)
  {
  CString cstrSQL;
  short int iRet = FAIL;
...
iUpdate_study_201_202 - Update the StudyData database table from
  ...
  return: SUCCESS if the table was updated.
          FAIL if there was an errorl
********************************************************************/
int CDbaccess::iUpdate_study_201_202(void)
  {
  CString cstrSQL;
  short int iRet = FAIL;
...
iAdd_event_table_201 - Add the Events table.  This makes it version 2.01.
  ...
  return: SUCCESS if the table was created.
          FAIL if there was an errorl
********************************************************************/
short int CDbaccess::iAdd_event_table_201(void)
  {
  CString cstrSQL;
  short int iRet = FAIL;
...
iAdd_whatif_table_202 - Add the WhatIf table.  This makes it version 2.02.
  ...
  return: SUCCESS if the table was createde.
          FAIL if there was an error.
********************************************************************/
short int CDbaccess::iAdd_whatif_table_202(void)
  {
  CString cstrSQL;
  short int iRet = FAIL;
...
********************************************************************/
short int CDbaccess::iGet_major_version(CString cstrVersion)
  {
  short int iVersion;
...
********************************************************************/
short int CDbaccess::iGet_minor_version(CString cstrVersion)
  {
  CString cstrMinor;
...
iUpdate_version - Write the new version into the Version table.
  ...
  return: SUCCESS if the table was updated.
          FAIL if there was an errorl
********************************************************************/
int CDbaccess::iUpdate_version(void)
  {
